...
public class Amendment03 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_amendment03);

        setTitle("Amendment 03");

        TextView textView = findViewById(R.id.content);

        textView.setText("THE CONSTITUTION (THIRD AMENDMENT) ACT, 1954\n" +
                "\n" +
